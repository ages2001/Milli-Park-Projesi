...
namespace proje2_1
{
    ...
    class Program
    {
        static void listYazdir(List<MilliPark> list1, List<MilliPark> list2)
        {
            Console.WriteLine("\n15000 hektardan kucuk milli parklar: \n");

            int count1 = 1, count2 = 1;
            int list1toplam = 0, list2toplam = 0;

            foreach (MilliPark milliPark in list1)
            {
                Console.WriteLine("\nMilli park {0}: \n", count1);
                Console.WriteLine(milliPark);
                list1toplam += milliPark.Yuzolcumu;
                count1++;
            }

            Console.WriteLine("\n\n15000 hektar ve daha buyuk milli parklar: \n");

            foreach (MilliPark milliPark in list2)
            {
                Console.WriteLine("\nMilli park {0}: \n", count2);
                Console.WriteLine(milliPark);
                list2toplam += milliPark.Yuzolcumu;
                count2++;
            }
        ...
        static void milliParkEkle(MilliPark milliPark0)
        {
            if (milliPark0.Yuzolcumu < 15000)
                MilliPark.milliParkLists[0].Add(milliPark0);

            else
                MilliPark.milliParkLists[1].Add(milliPark0);
        }
        ...
        static void Main(string[] args)
        {
            ...
            MilliPark.milliParkLists[0] = new List<MilliPark>();
            MilliPark.milliParkLists[1] = new List<MilliPark>();
