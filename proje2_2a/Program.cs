...
namespace proje2_2a
{
    class MilliPark
    {
        ...
        public static Stack[] milliParkLists = new Stack[2];
    ...
    class Stack
    {
        ...
        {
            milliParkList[++top] = milliPark;
        }

        public MilliPark Pop() 
        {
            return milliParkList[top--];
        }
    ...
    class Program
    {
        static void listYazdir(Stack list1, Stack list2)
        {
            ...
            {
                count1++;
                MilliPark removedMilliPark = list1.Pop();
                Console.WriteLine("\nMilli park {0}: \n", count1);
            ...
            {
                count2++;
                MilliPark removedMilliPark = list2.Pop();
                Console.WriteLine("\nMilli park {0}: \n", count2);
                Console.WriteLine(removedMilliPark);
        ...
        static void milliParkEkle(MilliPark milliPark0)
        {
            if (milliPark0.Yuzolcumu < 15000)
                MilliPark.milliParkLists[0].Push(milliPark0);

            else
                MilliPark.milliParkLists[1].Push(milliPark0);
        }
        ...
        static void Main(string[] args)
        {
            ...
            MilliPark.milliParkLists[0] = new Stack(48);
            MilliPark.milliParkLists[1] = new Stack(48);
